...
def test_change_password(create_user, make_flask_post_request, login_user):
    ...
    make_flask_post_request(
        path="change_password", data={"password": "new_testtest"}, headers={"Authorization": f"Bearer {access_token}"}
    )
